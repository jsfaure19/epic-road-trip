					...
					<div className="main-bar clearfix ">
						<div className="container clearfix">
							<div className="logo-header mostion">
								<Link to={"./"} className="logo-1"><img src={require("../../images/logothumbnail.png")} alt="" /></Link>
								<Link to={"./"} className="logo-2"><img src={require("./../../images/logothumbnail.png")} alt="" /></Link> 
							</div>
...
{/* 							<div className="extra-nav">
							...
							<div className="header-nav navbar-collapse collapse myNavbar justify-content-end" id="navbarNavDropdown">
								<ul className="nav navbar-nav">              
									<li className="down active"><Link to={"#"}>Accueil <i className="fa fa-chevron-down"></i></Link>
										<ul className="sub-menu">
											<li><Link to={"/"}>Home 1</Link></li>
											<li><Link to={"/"}>Home 2<span className="tag-new">New</span></Link></li>
											<li><Link to={"/"}>Home 3<span className="tag-new">New</span></Link></li>
										</ul>
									</li>
									<li className="down"><Link to={"#"}># <i className="fa fa-chevron-down"></i></Link>
										<ul className="sub-menu">
